...
<div className="flex items-center gap-2">
  ...
  >
    <Link to="/commande" className="flex items-center px-4 py-2 font-medium">
      <ShoppingCart className="mr-2 h-5 w-5 text-pink-700 dark:text-pink-500 transition-transform group-hover:scale-110" />
